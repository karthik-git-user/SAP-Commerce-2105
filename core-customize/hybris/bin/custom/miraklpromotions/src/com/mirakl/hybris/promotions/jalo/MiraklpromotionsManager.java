...
/**
 * This is the extension manager of the Miraklpromotions extension.
 */
public class MiraklpromotionsManager extends GeneratedMiraklpromotionsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklpromotionsManager.class);
	 ...
	 */
	public static MiraklpromotionsManager getInstance()
	{
		return (MiraklpromotionsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklpromotionsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklpromotionsManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklpromotionsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklpromotionsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklpromotionsManager called, current tenant: {}", getTenant().getTenantID());
	}
