 ...
 */
package com.mirakl.hybris.backofficeaddon.jalo;
...
import com.mirakl.hybris.backofficeaddon.constants.MiraklbackofficeaddonConstants;
 ...
 */
public class MiraklbackofficeaddonManager extends GeneratedMiraklbackofficeaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MiraklbackofficeaddonManager.class.getName());
	 ...
	 */
	public static MiraklbackofficeaddonManager getInstance()
	{
		return (MiraklbackofficeaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklbackofficeaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklbackofficeaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MiraklbackofficeaddonManager called.");
		}
	}
