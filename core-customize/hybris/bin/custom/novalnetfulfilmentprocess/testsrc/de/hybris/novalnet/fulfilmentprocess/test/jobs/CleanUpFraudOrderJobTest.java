 ...
 */
package de.hybris.novalnet.fulfilmentprocess.test.jobs;
...
import de.hybris.novalnet.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = NovalnetFulfilmentProcessConstants.ORDER_PROCESS_NAME;
