...
/**
 * This is the extension manager of the Miraklcatalogintegrator extension.
 */
public class MiraklcatalogintegratorManager extends GeneratedMiraklcatalogintegratorManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklcatalogintegratorManager.class);
	 ...
	 */
	public static MiraklcatalogintegratorManager getInstance()
	{
		return (MiraklcatalogintegratorManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklcatalogintegratorConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklcatalogintegratorManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklcatalogintegratorManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklcatalogintegratorManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklcatalogintegratorManager called, current tenant: {}", getTenant().getTenantID());
	}
