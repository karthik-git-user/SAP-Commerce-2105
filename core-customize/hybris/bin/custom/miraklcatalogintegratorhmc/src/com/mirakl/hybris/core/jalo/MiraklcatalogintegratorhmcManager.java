...
import com.mirakl.hybris.core.constants.MiraklcatalogintegratorhmcConstants;



/**
 * This is the extension manager of the Miraklcatalogintegratorhmc extension.
 */
public class MiraklcatalogintegratorhmcManager extends GeneratedMiraklcatalogintegratorhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklcatalogintegratorhmcManager.class);
	 ...
	 */
	public static MiraklcatalogintegratorhmcManager getInstance()
	{
		return (MiraklcatalogintegratorhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklcatalogintegratorhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklcatalogintegratorhmcManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklcatalogintegratorhmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklcatalogintegratorhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklcatalogintegratorhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
