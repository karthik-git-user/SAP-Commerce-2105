...
import com.mirakl.hybris.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
    ...
    private static final PropertyConfigSwitcher canJoinPreviousNodeSwitcher =
        new PropertyConfigSwitcher("processengine.process.canjoinpreviousnode.default");
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/miraklfulfilmentprocess/test/miraklfulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/miraklfulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/miraklfulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/miraklfulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/miraklfulfilmentprocess/test/process/consignment-process.xml");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/miraklfulfilmentprocess/test/miraklfulfilmentprocess-spring-testcleanup.xml"));
