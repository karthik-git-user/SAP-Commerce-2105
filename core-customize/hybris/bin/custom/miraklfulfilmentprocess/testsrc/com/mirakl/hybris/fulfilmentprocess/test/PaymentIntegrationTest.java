...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		definitonFactory.add("classpath:/miraklfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/miraklfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/miraklfulfilmentprocess/test/testCatalog.csv", "windows-1252");
