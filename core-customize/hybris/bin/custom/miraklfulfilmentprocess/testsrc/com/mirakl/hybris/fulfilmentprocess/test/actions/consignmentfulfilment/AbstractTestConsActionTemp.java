 ...
 *  
 */
package com.mirakl.hybris.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, MiraklfulfilmentprocessConstants.PARENT_PROCESS);
