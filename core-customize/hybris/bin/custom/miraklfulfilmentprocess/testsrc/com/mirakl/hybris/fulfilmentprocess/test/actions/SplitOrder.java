 ...
 *  
 */
package com.mirakl.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MiraklfulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MiraklfulfilmentprocessConstants.PARENT_PROCESS);
