 ...
 * 
 */
package com.mirakl.hybris.fulfilmentprocess.constants;

public final class MiraklfulfilmentprocessConstants extends GeneratedMiraklfulfilmentprocessConstants {
  public static final String CONSIGNMENT_SUBPROCESS_END_EVENT_NAME = "ConsignmentSubprocessEnd";
  public static final String ORDER_PROCESS_NAME = "mirakl-order-process";
  public static final String CONSIGNMENT_SUBPROCESS_NAME = "consignment-process";
  public static final String MARKETPLACE_CONSIGNMENT_SUBPROCESS_NAME = "marketplaceconsignment-process";
  ...
  public static final String MAX_CONSIGNMENT_UPDATE_PAGE_SIZE = "miraklfulfilmentprocess.consignment.updates.pagesize";
}
