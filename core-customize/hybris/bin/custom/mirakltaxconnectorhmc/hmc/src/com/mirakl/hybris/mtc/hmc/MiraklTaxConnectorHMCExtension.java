package com.mirakl.hybris.mtc.hmc;
...
public class MiraklTaxConnectorHMCExtension extends HMCExtension {
  /** Edit the local|project.properties to change logging behavior (properties log4j.*). */
  @SuppressWarnings("unused")
  private static final Logger LOG = Logger.getLogger(MiraklTaxConnectorHMCExtension.class.getName());

  /** Path to the resource bundles. */
  public static final String RESOURCE_PATH = "com.mirakl.hybris.TaxConnector.hmc.locales";
