...
import com.mirakl.hybris.mtc.constants.MirakltaxconnectorhmcConstants;



/**
 * This is the extension manager of the Mirakltaxconnectorhmc extension.
 */
public class MirakltaxconnectorhmcManager extends GeneratedMirakltaxconnectorhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MirakltaxconnectorhmcManager.class);
	 ...
	 */
	public static MirakltaxconnectorhmcManager getInstance()
	{
		return (MirakltaxconnectorhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MirakltaxconnectorhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MirakltaxconnectorhmcManager() // NOPMD
	{
		LOG.debug("constructor of MirakltaxconnectorhmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MirakltaxconnectorhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MirakltaxconnectorhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
