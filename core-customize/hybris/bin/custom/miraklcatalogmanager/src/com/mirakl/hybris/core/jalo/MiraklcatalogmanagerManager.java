...
import com.mirakl.hybris.core.constants.MiraklcatalogmanagerConstants;



/**
 * This is the extension manager of the Miraklcatalogmanager extension.
 */
public class MiraklcatalogmanagerManager extends GeneratedMiraklcatalogmanagerManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklcatalogmanagerManager.class);
	 ...
	 */
	public static MiraklcatalogmanagerManager getInstance()
	{
		return (MiraklcatalogmanagerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklcatalogmanagerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklcatalogmanagerManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklcatalogmanagerManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklcatalogmanagerManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklcatalogmanagerManager called, current tenant: {}", getTenant().getTenantID());
	}
