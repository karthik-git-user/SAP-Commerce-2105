 ...
 */
package com.mirakl.hybris.b2bcore.jalo;
...
import com.mirakl.hybris.b2bcore.constants.Miraklb2bservicesConstants;



/**
 * This is the extension manager of the Miraklb2bservices extension.
 */
public class Miraklb2bservicesManager extends GeneratedMiraklb2bservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Miraklb2bservicesManager.class);
	 ...
	 */
	public static Miraklb2bservicesManager getInstance()
	{
		return (Miraklb2bservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Miraklb2bservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Miraklb2bservicesManager() // NOPMD 
	{
		LOG.debug("constructor of Miraklb2bservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Miraklb2bservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Miraklb2bservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
