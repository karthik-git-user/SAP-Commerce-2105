...
<div class="image-gallery js-gallery">
    <span class="gallery-zoom-icon image-gallery__zoom-icon glyphicon glyphicon-resize-full"></span>

    <c:choose>
        <c:when test="${galleryImages == null || galleryImages.size() == 0}">
            <div class="carousel gallery-image image-gallery__image js-gallery-image">
                <div class="item">
                    <div>
