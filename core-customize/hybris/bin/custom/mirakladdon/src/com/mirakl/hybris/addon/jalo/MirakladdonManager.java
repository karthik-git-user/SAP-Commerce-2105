 ...
 *  
 */
package com.mirakl.hybris.addon.jalo;
...
import com.mirakl.hybris.addon.constants.MirakladdonConstants;



/**
 * This is the extension manager of the Mirakladdon extension.
 */
public class MirakladdonManager extends GeneratedMirakladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MirakladdonManager.class.getName());
	 ...
	 */
	public static MirakladdonManager getInstance()
	{
		return (MirakladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MirakladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MirakladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MirakladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MirakladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MirakladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
