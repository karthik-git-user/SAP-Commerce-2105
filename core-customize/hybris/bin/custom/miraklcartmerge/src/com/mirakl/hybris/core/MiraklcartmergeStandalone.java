 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.mirakl.hybris.core.MiraklcartmergeStandalone().run();"
 ...
 */
public class MiraklcartmergeStandalone {
  /**
  ...
  public static void main(final String[] args) {
    new MiraklcartmergeStandalone().run();
  }
