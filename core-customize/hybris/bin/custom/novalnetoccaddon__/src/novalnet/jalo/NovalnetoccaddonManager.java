...
import novalnet.constants.NovalnetoccaddonConstants;



/**
 * This is the extension manager of the novalnetoccaddon extension.
 */
public class NovalnetoccaddonManager extends GeneratedNovalnetoccaddonManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(NovalnetoccaddonManager.class.getName());
	 ...
	 */
	public NovalnetoccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NovalnetoccaddonManager called.");
		}
	}
	 ...
	 */
	public static NovalnetoccaddonManager getInstance()
	{
		return (NovalnetoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(NovalnetoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NovalnetoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NovalnetoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
