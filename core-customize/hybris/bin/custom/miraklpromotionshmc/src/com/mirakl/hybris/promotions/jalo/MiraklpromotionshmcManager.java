 ...
 */
package com.mirakl.hybris.promotions.jalo;
...
import com.mirakl.hybris.promotions.constants.MiraklpromotionshmcConstants;



/**
 * This is the extension manager of the Miraklpromotionshmc extension.
 */
public class MiraklpromotionshmcManager extends GeneratedMiraklpromotionshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklpromotionshmcManager.class);
	 ...
	 */
	public static MiraklpromotionshmcManager getInstance()
	{
		return (MiraklpromotionshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklpromotionshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklpromotionshmcManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklpromotionshmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklpromotionshmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklpromotionshmcManager called, current tenant: {}", getTenant().getTenantID());
	}
