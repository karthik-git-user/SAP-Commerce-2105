 ...
 *  
 */
package com.mirakl.hybris.miraklsampledataaddon.jalo;
...
import com.mirakl.hybris.miraklsampledataaddon.constants.MiraklsampledataaddonConstants;



/**
 * This is the extension manager of the Miraklsampledataaddon extension.
 */
public class MiraklsampledataaddonManager extends GeneratedMiraklsampledataaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MiraklsampledataaddonManager.class.getName());
	 ...
	 */
	public static MiraklsampledataaddonManager getInstance()
	{
		return (MiraklsampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MiraklsampledataaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklsampledataaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MiraklsampledataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MiraklsampledataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MiraklsampledataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
