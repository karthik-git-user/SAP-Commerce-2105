...
import com.mirakl.hybris.channelsaddon.constants.MiraklchannelsaddonhmcConstants;



/**
 * This is the extension manager of the Miraklchannelsaddonhmc extension.
 */
public class MiraklchannelsaddonhmcManager extends GeneratedMiraklchannelsaddonhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklchannelsaddonhmcManager.class);
	 ...
	 */
	public static MiraklchannelsaddonhmcManager getInstance()
	{
		return (MiraklchannelsaddonhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklchannelsaddonhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklchannelsaddonhmcManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklchannelsaddonhmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklchannelsaddonhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklchannelsaddonhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
