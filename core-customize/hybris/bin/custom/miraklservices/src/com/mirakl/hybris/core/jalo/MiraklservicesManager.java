...
/**
 * This is the extension manager of the Miraklservices extension.
 */
public class MiraklservicesManager extends GeneratedMiraklservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MiraklservicesManager.class.getName());
	 ...
	 */
	public static MiraklservicesManager getInstance()
	{
		return (MiraklservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
	 ...
	 */
	public MiraklservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MiraklservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MiraklservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MiraklservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
