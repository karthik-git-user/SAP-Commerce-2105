...
public class DefaultEffectiveBasePriceDynamicHandler extends AbstractDynamicAttributeHandler<BigDecimal, OfferModel> {

  protected MiraklPriceService miraklPriceService;

  @Override
  public BigDecimal get(OfferModel model) {
    return miraklPriceService.getOfferBasePrice(model);
  }
