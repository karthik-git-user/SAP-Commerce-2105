...
public class DefaultEffectiveTotalPriceDynamicHandler extends AbstractDynamicAttributeHandler<BigDecimal, OfferModel> {

  protected MiraklPriceService miraklPriceService;

  @Override
  public BigDecimal get(OfferModel model) {
    return miraklPriceService.getOfferTotalPrice(model);
  }
