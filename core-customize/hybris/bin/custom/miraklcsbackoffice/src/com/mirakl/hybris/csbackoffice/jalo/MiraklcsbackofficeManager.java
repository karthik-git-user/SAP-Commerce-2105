 ...
 */
package com.mirakl.hybris.csbackoffice.jalo;
...
import com.mirakl.hybris.csbackoffice.constants.MiraklcsbackofficeConstants;



/**
 * This is the extension manager of the Miraklcsbackoffice extension.
 */
public class MiraklcsbackofficeManager extends GeneratedMiraklcsbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklcsbackofficeManager.class);
	 ...
	 */
	public static MiraklcsbackofficeManager getInstance()
	{
		return (MiraklcsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklcsbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklcsbackofficeManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklcsbackofficeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklcsbackofficeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklcsbackofficeManager called, current tenant: {}", getTenant().getTenantID());
	}
