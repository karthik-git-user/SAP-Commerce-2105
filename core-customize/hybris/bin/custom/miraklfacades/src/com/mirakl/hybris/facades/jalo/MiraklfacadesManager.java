 ...
 */
package com.mirakl.hybris.facades.jalo;
...
import com.mirakl.hybris.facades.constants.MiraklfacadesConstants;



/**
 * This is the extension manager of the Miraklfacades extension.
 */
public class MiraklfacadesManager extends GeneratedMiraklfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MiraklfacadesManager.class.getName());
	 ...
	 */
	public static MiraklfacadesManager getInstance()
	{
		return (MiraklfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MiraklfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MiraklfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MiraklfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MiraklfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
