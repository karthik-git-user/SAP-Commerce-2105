...
import com.mirakl.hybris.core.constants.MiraklserviceshmcConstants;



/**
 * This is the extension manager of the Miraklserviceshmc extension.
 */
public class MiraklserviceshmcManager extends GeneratedMiraklserviceshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklserviceshmcManager.class);
	 ...
	 */
	public static MiraklserviceshmcManager getInstance()
	{
		return (MiraklserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklserviceshmcManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklserviceshmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklserviceshmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklserviceshmcManager called, current tenant: {}", getTenant().getTenantID());
	}
