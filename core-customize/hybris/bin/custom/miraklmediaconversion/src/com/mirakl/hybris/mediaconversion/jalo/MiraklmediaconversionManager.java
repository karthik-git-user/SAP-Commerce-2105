 ...
 */
package com.mirakl.hybris.mediaconversion.jalo;
...
import com.mirakl.hybris.mediaconversion.constants.MiraklmediaconversionConstants;



/**
 * This is the extension manager of the Miraklmediaconversion extension.
 */
public class MiraklmediaconversionManager extends GeneratedMiraklmediaconversionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklmediaconversionManager.class);
	 ...
	 */
	public static MiraklmediaconversionManager getInstance()
	{
		return (MiraklmediaconversionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklmediaconversionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklmediaconversionManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklmediaconversionManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklmediaconversionManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklmediaconversionManager called, current tenant: {}", getTenant().getTenantID());
	}
