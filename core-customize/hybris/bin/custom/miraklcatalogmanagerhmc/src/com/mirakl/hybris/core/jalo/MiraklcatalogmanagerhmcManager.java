...
import com.mirakl.hybris.core.constants.MiraklcatalogmanagerhmcConstants;



/**
 * This is the extension manager of the Miraklcatalogmanagerhmc extension.
 */
public class MiraklcatalogmanagerhmcManager extends GeneratedMiraklcatalogmanagerhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MiraklcatalogmanagerhmcManager.class);
	 ...
	 */
	public static MiraklcatalogmanagerhmcManager getInstance()
	{
		return (MiraklcatalogmanagerhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MiraklcatalogmanagerhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MiraklcatalogmanagerhmcManager() // NOPMD 
	{
		LOG.debug("constructor of MiraklcatalogmanagerhmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MiraklcatalogmanagerhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MiraklcatalogmanagerhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
